...
A web app that uses your phone camera to detect the **EKO mascot** and launch an AR experience 
...
4. If the app detects the mascot , it automatically redirects you to the WebAR experience
